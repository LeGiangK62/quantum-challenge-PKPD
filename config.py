...
class Config:
    ...
    # Data splitting
    split_strategy: str = "stratify_dose_even_no_placebo_test" # "stratify_dose_even", "stratify_dose_even_no_placebo_test", "leave_one_dose_out", "random_subject", "only_bw_range"
    test_size: float = 0.1
    val_size: float = 0.1
    random_state: int = 42
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    # Data splitting
    parser.add_argument("--split_strategy", default="stratify_dose_even_no_placebo_test", 
...
def parse_args() -> Config:
    ...
    config = Config(
        ...
        # For model settings
        encoder=args.encoder, # Encoder type
